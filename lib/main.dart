...
import 'package:camera_windows_example/home/welcomscreen.dart';
...
class ActualCameraPage extends StatefulWidget {
  /// Default Constructor
  const ActualCameraPage({super.key});

  @override
  State<ActualCameraPage> createState() => _ActualCameraPageState();
}

class _ActualCameraPageState extends State<ActualCameraPage> {
