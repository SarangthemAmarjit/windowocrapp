...
class OpencvExmp extends StatefulWidget {
  const OpencvExmp({super.key});

  @override
  State<OpencvExmp> createState() => _OpencvExmpState();
}

class _OpencvExmpState extends State<OpencvExmp> {
