...
class PaymentResultDialog extends StatelessWidget {
  ...
  const PaymentResultDialog(
      {super.key, required this.isSuccess, required this.callback, required this.amount});
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isSuccess ? "Payment successfully processed" : "Payment Failed to Process",
              style: TextStyle(
                fontSize: 26,
            ...
            isSuccess
                ? Text(
                    "Your payment of Rs ${amount} for the ${mngctrl.getPermitPrice?.permitName} is successfull. Please wait while we generate your receipt.",
