                                                  ...
                                                  children: [
                                                    ...
                                                    labeltext(label: "S/O,D/o,/W/O:",title: "${mngctrl.currentPermit?.applcntParent}",),
                                                     labeltext(label: "DOB: ",title: "${getDate(dateTime:mngctrl.currentPermit?.applcntDOB )}",),
                                                      ...
                                                      labeltext(title: "${mngctrl.currentPermit?.applcntAddress},${mngctrl.currentPermit?.applcntPoliceStation}".capitalize!,label: "Address: ",)
                                                  ],
                                                ),
                                              ),
                                            )
                                ...
                                Container(
                                    ...
                                    child: Column(
                                      children: [
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    labeltext(label: 'Residing: ',title: "FGhfgdhgfhd vhdjhvjd"),
                                                    labeltext(label:"purpose", title: "Business"),
                                                    labeltext(
                                                        label:"LR: ", title:" Manthjsjfhdjg ghjd",
                                                      ),
                                        ...
                                        Row(
                                          children: [
                                            Text('Date of Issue:\n12/3/2025',style: TextStyle(fontSize:24,color: Colors.black),),
                                            SizedBox(width: 30,),
                                            Text('Date of Expiry:\n12/3/2025',style: TextStyle(fontSize:24,color: Colors.black)),
                                          ],
                                        )
