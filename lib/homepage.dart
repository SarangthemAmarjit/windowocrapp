...
class IdSelectionAndScanningScreen extends StatefulWidget {
  @override
  _IdSelectionAndScanningScreenState createState() => _IdSelectionAndScanningScreenState();
}

class _IdSelectionAndScanningScreenState extends State<IdSelectionAndScanningScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<Imagecontroller>()
          .initializeCamera(isfront: true, isback: false, isprofilecam: false);
      saveId = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PagenavControllers>(builder: (_) {
      return GetBuilder<Imagecontroller>(builder: (_) {
        log("imgcon.isFrontcapturebuttonpress : " + imgcon.isFrontcapturebuttonpress.toString());
                                          ...
                                          InkWell(
                                            onTap: () {
                                              ...
                                              imgcon.takeDocIDImage(
                                                  IdcaptureKey, imgcon.frontImages == null);
                      ...
                      : Stack(
                          children: [
                            RepaintBoundary(
                              ...
                              ).animate().fadeIn(duration: Duration(milliseconds: 800)).scaleXY(
                                  begin: 0.5,
                                  end: 1,
                                  curve: Curves.easeIn,
