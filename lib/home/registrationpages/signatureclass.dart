                ...
                children: [
                              ...
                              child: Column(
                                children: [
                                  GestureDetector(
                                    ...
                                    child: CustomPaint(
                                      painter:
                                          _DrawingPainter(points, Size(canvasWidth, canvasHeight)),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: InkWell(
                          onTap: points.isEmpty && imgcon.signature == null
                              ? null
                              : () {
                                  _clearDrawing();
                          ...
                          child: Container(
                            ...
                            padding: EdgeInsets.all(32),
                            decoration: BoxDecoration(
                              color: points.isEmpty && imgcon.signature == null
                                  ? Colors.blue[200]
                                  : Colors.blue,
                              // borderRadius: BorderRadius.circular(8)
                            ),
                      ...
                      duration: Duration(milliseconds: 1200), delay: Duration(milliseconds: 400)),
                ],
              ),
            )
                .animate()
