...
class _SuccesspagesState extends State<Successpages> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (Get.find<PagenavControllers>().mainpageindex == 7 ||
          Get.find<PagenavControllers>().mainpageindex == 5 ||
          Get.find<Imagecontroller>().receipt != null) {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                          ...
                          child: pagectrl.mainpageindex == 7 ||
                                  pagectrl.mainpageindex == 5 ||
                                  imgcon.receipt != null
                              ? Lottie.asset('assets/receipt.json', repeat: false)
                              : SizedBox())
                      .animate()
                      .fadeIn()
                  ...
                  pagectrl.mainpageindex == 7
                      ? Text("Current Permit Holder not Exited.\nYou must exit the current permit before applying for a new one\nPlease collect your receipt and go to the ILP Counter",
                              style: TextStyle(fontSize: 30), textAlign: TextAlign.center)
                          .animate()
                          .fadeIn()
                          .slideY(begin: 1, end: 0, delay: Duration(milliseconds: 400))
                      : pagectrl.mainpageindex == 6
                          ? Text("Failed to process Online Payment.\nYour Receipt has been Generated. Please collect your receipt and go to the ILP Counter",
                                  style: TextStyle(fontSize: 30), textAlign: TextAlign.center)
                              .animate()
                              .fadeIn()
                              .slideY(begin: 1, end: 0, delay: Duration(milliseconds: 400))
                          : imgcon.receipt != null
                              ? Text("Your Receipt Has been Generated. Please collect your receipt and go to the ILP Counter",
                                      style: TextStyle(fontSize: 30), textAlign: TextAlign.center)
                                  .animate()
                                  .fadeIn()
                                  .slideY(begin: 1, end: 0, delay: Duration(milliseconds: 400))
                              : pagectrl.mainpageindex == 5
                                  ? Text(
                                      "Your Receipt Has been Generated. Please collect your receipt",
                                      style: TextStyle(fontSize: 30),
                                      textAlign: TextAlign.center,
                                    )
                                      .animate()
                                      .fadeIn()
                                      .slideY(begin: 0, end: 0, delay: Duration(milliseconds: 400))
                                  : Text(
                                      "Failed to generate permit.Please try again",
                                      style: TextStyle(fontSize: 30),
                                      textAlign: TextAlign.center,
                                    )
                                      .animate()
