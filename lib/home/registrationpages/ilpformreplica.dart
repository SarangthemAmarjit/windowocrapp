...
class _TemporaryILPFormReplicaState extends State<TemporaryILPFormReplica> {
  ...
  final _localresidencephone = TextEditingController();
  ...
  void initState() {
    ...
    controllers = {
      ...
      'localResidencePhone': _localresidencephone,
    };
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) {
        ...
        _localresidencephone.text = d.lrPhone ?? "";
        if (d.district != null && d.district!.isNotEmpty) {
          district = d.district ?? "";
        }
        if (d.applcntName != null && d.applcntName!.isNotEmpty) {
          setState(() {
            appnotexist = false;
          });
        }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      mngctrl.isUserAlreadyexist &&
                          ...
                          ? Text(
                              "Welcome Back, ${mngctrl.getPermit?.applcntName?.capitalize}",
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                            child: _buildTextField('ID No.', _idNoController,
                                                node: _focusNodes['idNo']!, enabled: false)),
                                      ],
                                    ).animate().fadeIn(delay: Duration(milliseconds: 0)),
                                    Row(
                                      children: [
                                        Expanded(
                                            child: _buildTextField(
                                                ...
                                                node: _focusNodes['name']!, enabled: appnotexist)),
                                        SizedBox(
                                          width: 20,
                                        ),
                                        Expanded(
                                        ...
                                        Expanded(
                                          child: _buildDateField('* Date of Birth', _dob, (value) {
                                            ...
                                            if (_dob == null) {
                                              ...
                                              lastdate: DateTime.now(), isappnotexist: appnotexist),
                                        ),
                                        SizedBox(
                                          width: 20,
                                        ),
                                        ...
                                        Expanded(
                                          child: Column(
                                            children: [
                                              _buildDropdownField(
                                                  'State',
                                                  appnotexist ? states : [mngctrl.state ?? "state"],
                                                  mngctrl.state, (value) {
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: _buildTextField(
                                              node: _focusNodes['nearestPolice']!,
                                              'Police Station',
                                        ...
                                        Expanded(
                                            child: _buildTextField(
                                                mandatory: false,
                                                node: _focusNodes['tehsil']!,
                                                enabled: mngctrl.getPermit != null &&
                                                        mngctrl.getPermit!.applcntTehsil != null &&
                                                        mngctrl.getPermit!.applcntTehsil!.isNotEmpty
                                                    ? false
                                                    : true,
                                                'Tehsil', validator: (p) {
                                          return null;
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: _buildTextField(
                                            node: _focusNodes['localPoliceStation']!,
                                      ...
                                      children: [
                                              ...
                                              children: [
                                                ...
                                                mngctrl.purpose == "Others"
                                                    ? AnimatedOpacity(
                                                        ...
                                                        opacity:
                                                            mngctrl.purpose == "Others" ? 1 : 0,
                                                        child: Column(
                                                          crossAxisAlignment:
                                                              CrossAxisAlignment.start,
                                                          children: [
                                                            _buildTextField(
                                                                node: _focusNodes['visitPurpose']!,
                                        ...
                                        Expanded(
                                          child: Column(
                                            children: [
                                              _buildTextField(
                                                node: _focusNodes['localResidenceName']!,
                                                'Local Residence',
                                                validator: (p) {
                                                  return null;
                                                },
                          ...
                          if (firspage) {
                            ...
                            if (_formkey.currentState!.validate() &&
                              ...
                              VisitorEntry permits = VisitorEntry(
                                ...
                                applcntPoliceStation: _nearestpliceController.text.trim(),
                                ...
                                lrPhone: _localresidencephone.text.trim(),
                                visitDate: DateTime(DateTime.now().year, DateTime.now().month,
                                        DateTime.now().day)
                                    .toIso8601String(),
  ...
  Widget _buildDateField(String label, DateTime? selectedDate,
      ...
      {DateTime? lastdate, required bool isappnotexist}) {
    return Padding(
  ...
  Widget _buildRadioGroup(
      String label, List<String> options, String? selectedValue, ValueChanged<String?> onChanged) {
                          ...
                          child: Center(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    fontSize: 18,
                                    color: selectedValue == option ? Colors.white : null),
                              ),
                            ],
                          )),
